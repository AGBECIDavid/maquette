...
function App() {
  ...
  if (!mounted) {
    return (
      <div className="splash" data-static="true" role="status" aria-label="Chargement de Ticket Tout">
        <div className="splash__in">
          <div className="splash__mark"><span className="splash__ring" /><span className="splash__tile">TT</span></div>
...
createRoot(document.getElementById("tickettout-root")).render(<StrictMode><App /></StrictMode>);
