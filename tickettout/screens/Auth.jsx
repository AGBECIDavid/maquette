...
export function Login() {
  ...
  return (
    <div className="auth">
      <Side
        title="Votre budget Ticket Tout, où que vous soyez."
      ...
      <div className="auth__form">
        <form className="auth__box" onSubmit={submit}>
          <h1>Connexion</h1>
          <p className="sub">Accédez à votre espace Ticket Tout.</p>
    ...
    <div className="auth">
      <Side
        ...
        lead={role === "employee"
          ...
          : "L'adhésion au réseau Ticket Tout est gratuite. Votre dossier est instruit manuellement par la Direction du Numérique et de l'Innovation avant activation."}
