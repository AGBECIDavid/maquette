...
export function Splash({ onDone }) {
  ...
  return (
    <div className="splash" role="status" aria-label="Chargement de Ticket Tout">
      <div className="splash__in">
        <div className="splash__mark">
          <span className="splash__ring" />
          <span className="splash__ring" />
          <span className="splash__tile">TT</span>
        </div>
        <div style={{ textAlign: "center", display: "grid", gap: 6, justifyItems: "center" }}>
          <div className="splash__name">Ticket Tout</div>
...
const FEATURES = [
  ["qr", "Payer par QR code", "Le salarié présente un code à usage unique, valable trente minutes — le temps de faire la queue."],
...
export function Landing() {
  ...
  const [splash, setSplash] = useState(() => {
    ...
    try { return !sessionStorage.getItem("tickettout.splash"); } catch (e) { return true; }
  });
  const done = () => {
    setSplash(false);
    try { sessionStorage.setItem("tickettout.splash", "1"); } catch (e) { /* sans effet */ }
  };
    ...
    <>
      ...
      <section className="hero">
        <div className="hero__in">
          <div>
            ...
            <p className="lead">
              Le Ticket Tout, c&apos;est le principe du titre-restaurant, sans le restaurant. Votre
          ...
          <div className="showcard" aria-hidden="true">
            <div className="showcard__top">
              <div>
                <div className="paycard__brand">Ticket Tout</div>
      ...
      <div className="section">
        <div className="section__h">
          ...
          <p>Les fonctions attendues au cahier des charges JEB/DNI/2026-002 v1.1, toutes démontrables.</p>
        </div>
        ...
        <div className="section">
          ...
          <div className="grid g-3">
            {[
              ...
              ["store", "Partenaire", "Encaissez les paiements Ticket Tout, suivez vos recettes, arborez le sceau officiel du Ministère.", "/inscription?role=partner", "Demander l'adhésion"],
      ...
      <footer className="band">
        <div className="footer">
          <span><b style={{ color: "var(--ink-2)" }}>Ticket Tout</b> — Ministère du Job et Bonheur</span>
          <span>Direction du Numérique et de l&apos;Innovation</span>
          <span style={{ marginLeft: "auto" }} className="mono">JEB/DNI/2026-002 · v1.1</span>
        </div>
      </footer>
    </>
  );
