    ...
    <>
      <div className="pagehead">
        <div><h1>Tableau de bord</h1>
          <p>Encaissements Ticket Tout de {p.name}. Les montants sont reversés sur le compte de
  ...
  const saisieManuelle = () => {
    ...
    modal.open("Saisie manuelle du jeton", (
      <label className="field">
        ...
        <input className="input mono" autoFocus placeholder="TT1|a1b2 c3d4 e5f6 a7b8"
  ...
  const valider = async () => {
    ...
    try {
      const t = await api.raw.post("/transactions",
        { token: scan.token, partnerId: p.id, amount: cts, channel: "qr" });
      ...
      <div className="grid g-main">
        ...
        <section className="card">
          ...
          <div className="card__bd" style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            {[["Le salarié génère un QR", "Valable 30 minutes, utilisable une seule fois."],
    ...
    <>
      ...
      <div className="grid g-main">
        ...
        <section className="card">
          ...
          <div className="card__bd">
            <Note>
              Les encaissements Ticket Tout sont reversés sur l&apos;IBAN de l&apos;établissement à J+2
