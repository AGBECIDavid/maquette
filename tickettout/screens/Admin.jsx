    ...
    <>
      <div className="pagehead">
        <div><h1>Tableau de bord national</h1>
          <p>Volumétrie du dispositif Ticket Tout, tous employeurs et tous partenaires confondus.</p></div>
...
function ApiView() {
  ...
  return (
    <>
      <div className="pagehead"><div><h1>API</h1>
        <p>Interface REST documentée, échanges en JSON. Chaque geste de l&apos;interface passe par
          l&apos;un de ces points d&apos;entrée : la console en bas de page le montre en direct.</p></div></div>
